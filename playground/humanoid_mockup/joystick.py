...
# ==============================================================================
"""Joystick task for Mockup Humanoid. (based on Berkeley Humanoid)"""
...
from . import base as humanoid_mockup_base
...
from playground.humanoid_mockup.custom_rewards import reward_imitation
...
class Joystick(humanoid_mockup_base.HumanoidMockupEnv):
    ...
    def _post_init(self) -> None:
        ...
        if USE_IMITATION_REWARD:
            self.PRM = PolyReferenceMotion(
                "playground/humanoid_mockup/data/polynomial_coefficients.pkl"
            )
