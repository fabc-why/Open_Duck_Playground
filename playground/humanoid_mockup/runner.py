"""Runs training and evaluation loop for Humanoid Mockup."""

import argparse

from playground.common import randomize
from playground.common.runner import BaseRunner
from playground.humanoid_mockup import joystick


class HumanoidMockupRunner(BaseRunner):
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Humanoid Mockup Runner Script")
    parser.add_argument(
        "--output_dir",
        type=str,
        default="checkpoints",
    ...
    runner = HumanoidMockupRunner(args)
