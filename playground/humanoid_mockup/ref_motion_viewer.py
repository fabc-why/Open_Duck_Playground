...
from playground.humanoid_mockup import base
...
model_path = f"playground/humanoid_mockup/xmls/scene_{args.scene}.xml"
    ...
    while viewer.is_running():
        ...
        if counter % decimation == 0:
            ...
            if not all(val == 0.0 for val in command):
                ...
                if ref_motion.shape[0] == 28:
                    ref_joint_pos = ref_motion[0:10]
                ...
                new_qpos = default_qpos.copy()
                if new_qpos[7 : 7 + 10].shape[0] == ref_joint_pos.shape[0]:
                    new_qpos[7 : 7 + 10] = ref_joint_pos
                else:
                    print(
